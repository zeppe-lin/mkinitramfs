...
See L<mkinitramfs(8)> for more information.
...
If was set to B<1>, then mkinitramfs will attempt to run L<strip(1)>
...
L<mkinitramfs(8)>, L<mkinitramfs.config(5)>,
L<mkinitramfs.cmdline(7)>.
