...
Tinyramfs provides a way to control configuration dynamically via kernel
...
Hooks can provide their own breakpoints. See source code of hooks for more
information.
...
for ability to use I<UUID>, I<LABEL>, I<PARTUUID>. Note that I<PARTUUID> only
supported in util-linux'
L<blkid(8)|https://www.mankier.com/8/blkid>.
...
L<tinyramfs.config(5)|https://github.com/zeppe-lin/zeppe-lin/blob/master/tinyramfs/tinyramfs.config.5.pod>,
